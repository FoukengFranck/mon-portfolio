  ...
  const devProjects: DevProject[] = [
    {
      ...
      github: "https://github.com/user/food-delivery",
    ...
    },
    {
      ...
      github: "https://github.com/user/penny-mall",
      category: "E-commerce Platform",
    },
    {
      title: "Calculatrice Simple",
      description:
        "Réalisation d'une calculatrice simple utilisant HTML et CSS pour la structure et le style, et PHP pour effectuer le calcul.",
      image: "/calculatrice.png",
      tech: ["HTML", "CSS", "PHP"],
      github: "https://github.com/user/muhammad-portfolio",
    ...
    },
    {
      ...
      image: "/avatar.png",
      tech: ["HTML", "CSS", "JS"],
      github: "https://github.com/user/youtuber-site",
    ...
    },
    {
      ...
      github: "https://github.com/user/hotel-booking",
  ...
  const graphicProjects: GraphicProject[] = [
    {
      ...
      description: "Logo moderne pour une banque, symbole de confiance.",
      image: "/logofcrv.jpg",
  ...
  return (
    <div className="my-projects-container">
      ...
      <h2 className="text-3xl font-bold text-center mb-8 text-purple-700">
        {isGraphic ? "Graphic Design Projects" : "Development Projects"}
      </h2>
